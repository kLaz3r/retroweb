    ...
    <section className="container mx-auto flex min-h-[calc(100vh-5rem)] flex-col items-center justify-center gap-12 px-6 pb-12 md:flex-row md:justify-between">
      ...
      <div className="flex w-full flex-col items-center gap-8 md:hidden">
        ...
        <div className="relative flex w-full flex-col items-start justify-center gap-4 text-left">
          <motion.h2
            className="font-display text-brand-secondary text-2xl font-bold"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          <motion.h1
            className="font-display text-4xl leading-tight font-black sm:text-5xl"
          ...
          <motion.p
            className="font-body text-text-secondary relative w-full max-w-md text-lg sm:text-xl"
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6, delay: 0.8 }}
      ...
      <div className="relative hidden w-1/2 flex-col items-end justify-center gap-4 md:flex">
        <motion.h2
          className="font-display text-brand-secondary text-right text-2xl font-bold md:text-2xl"
        ...
        <motion.h1
          className="font-display text-right text-5xl leading-tight font-black md:text-6xl"
        ...
        <motion.p
          className="font-body text-text-secondary relative w-full text-right text-xl md:text-2xl"
        ...
        <motion.span
          className="absolute right-0 bottom-0 translate-y-40"
          initial={{ opacity: 0, scale: 0.5, rotate: -10 }}
